        ...
        <div className="bg-white shadow rounded-2xl p-8 border border-gray-100">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
              ...
              <Button variant="outline" className="bg-white" size="sm" onClick={() => navigate('/results')}>View Results</Button>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
              ...
              <Button variant="outline" className="bg-white" size="sm" onClick={() => navigate('/exercise/new')}>Start Practice</Button>
            </div>
          </div>
        </div>
      </main>
