...
type PublicEnvName =
  ...
  | 'NEXT_PUBLIC_RUB_PREPAYMENT_URL'
  | 'NEXT_PUBLIC_EUR_PROMO_CODE'
  | 'NEXT_PUBLIC_EUR_PROMO_PERCENT';
...
const PUBLIC_ENV: Record<PublicEnvName, string | undefined> = {
  ...
  NEXT_PUBLIC_RUB_PREPAYMENT_URL: process.env.NEXT_PUBLIC_RUB_PREPAYMENT_URL,
  NEXT_PUBLIC_EUR_PROMO_CODE: process.env.NEXT_PUBLIC_EUR_PROMO_CODE,
  NEXT_PUBLIC_EUR_PROMO_PERCENT: process.env.NEXT_PUBLIC_EUR_PROMO_PERCENT,
};
