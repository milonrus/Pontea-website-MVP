        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white shadow-sm border border-blue-100 text-primary text-sm font-bold mb-8">
              ...
              Набор на цикл 2024/2025 открыт
            </div>

            <h1 className="text-5xl lg:text-7xl font-display font-bold text-primary leading-tight mb-6 tracking-tight">
              Подготовка к <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-600">ARCHED</span>
            ...
            <p className="text-xl text-slate-600 mb-10 max-w-lg leading-relaxed">
              С любого уровня до поступления. Лучшая платформа для подготовки к <strong>ARCHED (PoliMi)</strong> и <strong>TIL-A (PoliTo)</strong>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Link href="/assessment">
                <Button
                  size="lg"
                  variant="primary"
                  className="shadow-xl shadow-accent/20 hover:shadow-accent/30 w-full sm:w-auto group border-transparent"
                >
                  Пройти диагностику
            ...
            <div className="flex items-center gap-4 text-sm font-medium">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-slate-600">Нам доверяют <span className="text-primary font-bold">500+ учеников</span></p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="relative lg:h-[600px] flex items-center justify-center">
            ...
            <div className="grid grid-cols-2 gap-5 relative z-10 w-full max-w-lg">
              ...
              >
                <StatBox icon={PlayCircle} value="40+ ч" label="Видеолекций" />
                <div className="bg-primary p-6 rounded-2xl text-white shadow-xl shadow-primary/20 relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-blue-100 text-sm font-medium">Поступление</div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-blue-50">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs font-bold text-green-600 uppercase">В эфире</span>
                  </div>
                  <div className="text-sm text-gray-600 font-medium mb-4">История архитектуры</div>
                ...
                <StatBox icon={Users} value="90+" label="Студентов в Италии" />
