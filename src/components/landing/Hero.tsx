...
const StatBox = ({
  ...
  <div className="landing-hero-stat-box">
...
const Hero: React.FC<HeroProps> = ({ locale = 'ru' }) => {
  ...
  return (
    <section className="landing-hero-section relative pt-20 pb-12 lg:pt-28 lg:pb-16 overflow-hidden">
      <div className="landing-hero-top-orb" />
      <div className="landing-hero-bottom-orb" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative lg:h-[600px] flex items-center justify-center">
            <div className="landing-hero-cards-backdrop" />
