...
const Hero: React.FC = () => {
  return (
    <section className="relative pt-20 pb-20 lg:pt-28 lg:pb-32 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-slate-600 mb-10 max-w-xl leading-relaxed">
              Поможем поступить в архитектурный вуз мечты!
            </p>
          ...
          <div className="relative lg:h-[600px] flex items-center justify-center">
            ...
            <div className="grid grid-cols-2 gap-5 relative z-10 w-full max-w-lg">
              ...
              >
                <StatBox icon={PlayCircle} value="40+" label="часов видеоуроков" />
                <div className="bg-primary p-6 rounded-2xl text-white shadow-xl shadow-primary/20 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-blue-100 text-sm font-medium">98% поступают в целевые вузы</div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-blue-50">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs font-bold text-green-600 uppercase">Сейчас в работе</span>
                  </div>
                  <div className="text-sm text-gray-600 font-medium mb-4">Пробный тест: История архитектуры</div>
                ...
                <StatBox icon={Users} value="90+" label="Учатся в Италии" />
