...
PRICING_EUR_INVOICE_WEBHOOK_URL=...        # required webhook for EUR invoice applications
PRICING_MENTORSHIP_APPLICATION_WEBHOOK_URL=... # required webhook for "Индивидуальный" plan applications
